class CfgVehicles {
	...
	class Item_Arty_AimingPost: Item_Base_F
	{
		...
		class TransportItems {
			MACRO_ADDITEM(ACE_Arty_AimingPost,2);
		};
	};

	class ACE_Arty_AimingPost_F: NonStrategic {
		XEH_ENABLED;
		scope = 2;
        scopeCurator = 2;
    ...
    class ACE_Arty_Collimator_Item: Item_Base_F {
        scope = 2;
        scopeCurator = 2;
        ...
        vehicleClass = "ACE_Arty_System";
        class TransportItems {
            MACRO_ADDITEM(ACE_Arty_Collimator,1);
        };
    };
	class ACE_Arty_Collimator_F: ThingX {
		XEH_ENABLED;
		scope = 2;
        scopeCurator = 2;
