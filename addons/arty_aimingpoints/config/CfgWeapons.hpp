class CfgWeapons {
	...
	class ACE_Arty_AimingPost_Item: InventoryItem_Base_F {
		type = 0;
		allowedSlots[] = {901};
	};
	
	class ACE_Arty_AimingPost: ACE_ItemCore {
        scope = 2;
        ...
        class ItemInfo: ACE_Arty_AimingPost_Item {
            mass = 20;
			uniformModel = PATHTOF(arty_aimingpost_equip_f.p3d);
        };
    };

    class ACE_Arty_Collimator: ACE_ItemCore {
        scope = 2;
